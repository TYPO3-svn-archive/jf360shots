 ...
 */
class tx_jf360shots_tsparserext
{
	/**
	...
	function displayMessage(&$params, &$tsObj)
	{
		...
		if (t3lib_utility_VersionNumber::convertVersionNumberToInteger(TYPO3_version) < 4003000) {
			...
			$cssPath = $GLOBALS['BACK_PATH'] . t3lib_extMgm::extRelPath('jf360shots');
	...
	<div class="typo3-message message-warning">
		<div class="message-header">' . $GLOBALS['LANG']->sL('LLL:EXT:jf360shots/locallang.xml:extmng.updatermsgHeader') . '</div>
		<div class="message-body">
			' . $GLOBALS['LANG']->sL('LLL:EXT:jf360shots/locallang.xml:extmng.updatermsg') . '
		</div>
	</div>';
		}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jf360shots/lib/class.tx_jf360shots_tsparserext.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jf360shots/lib/class.tx_jf360shots_tsparserext.php']);
}
?>