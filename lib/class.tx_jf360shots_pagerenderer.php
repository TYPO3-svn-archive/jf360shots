 ...
 */
class tx_jf360shots_pagerenderer
{
	public $conf = array();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jf360shots/lib/class.tx_jf360shots_pagerenderer.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jf360shots/lib/class.tx_jf360shots_pagerenderer.php']);
}
